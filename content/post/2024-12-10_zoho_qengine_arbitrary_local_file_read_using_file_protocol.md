...
Initially like all security researchers, My intinct was to test for good ol' **SSRF** test cases & check if, I am able to access their internal services or cloud metadata urls [169.254.169.254](https://book.hacktricks.xyz/pentesting-web/ssrf-server-side-request-forgery/cloud-ssrf).
